...
color_bin = 12;
while (color_bin <= 255)
    [unused color_index_dist color_index_map nBin] = RGBQuantization(im, color_bin, 0.95, false);
    if ( nBin < 100 )
...
[fg_color_hist, bg_color_hist, bboxs] =...
    buildContourTypeColorModel(shape_prior_segments, cluster_id,...
