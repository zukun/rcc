...
# /mnt/data/documents/Computer Vision/Computer Vision Courses - Lectures/Li Fei Fei - Recognizing and Learning Object Categories - ICCV2009/Demo of bag-of-word classifiers/bag_words_demo/bin/config/cmake/export/VXLConfig.cmake
#
...
SET(VXL_VCL_INCLUDE_DIR "/usr/local/include/vxl/vcl")
SET(VXL_VCL_LIBRARIES "vcl")

SET(VXL_CORE_FOUND "YES" ) # VXL core is always FOUND.  It is not optional.
SET(VXL_CORE_INCLUDE_DIR "/usr/local/include/vxl/core")
# VXL core has many libraries

SET(VXL_CORE_VIDEO_FOUND "YES" )
SET(VXL_CORE_VIDEO_INCLUDE_DIR "/usr/local/include/vxl/core")
...
SET(VXL_BRL_INCLUDE_DIR "/usr/local/include/vxl/contrib/brl;/usr/local/include/vxl/contrib/brl/bbas;/usr/local/include/vxl/contrib/brl/bseg;/usr/local/include/vxl/contrib/brl/bvml")
...
SET(VXL_GEL_INCLUDE_DIR "/usr/local/include/vxl/contrib/gel")
# VXL GEL has many libraries

SET(VXL_MUL_FOUND "ON")
SET(VXL_MUL_INCLUDE_DIR "/usr/local/include/vxl/contrib/mul")
# VXL MUL has many libraries

SET(VXL_OUL_FOUND "ON")
SET(VXL_OUL_INCLUDE_DIR "/usr/local/include/vxl/contrib/oul")
# VXL OUL has many libraries

SET(VXL_OXL_FOUND "ON")
SET(VXL_OXL_INCLUDE_DIR "/usr/local/include/vxl/contrib/oxl")
# VXL OXL has many libraries

SET(VXL_PRIP_FOUND "ON")
SET(VXL_PRIP_INCLUDE_DIR "/usr/local/include/vxl/contrib/prip")
# VXL PRIP has many libraries

SET(VXL_RPL_FOUND "ON")
SET(VXL_RPL_RGTL_FOUND "OFF")
SET(VXL_RPL_INCLUDE_DIR "/usr/local/include/vxl/contrib/rpl")
# VXL RPL has many libraries

SET(VXL_TBL_FOUND "ON")
SET(VXL_TBL_INCLUDE_DIR "/usr/local/include/vxl/contrib/tbl")
# VXL TBL has many libraries

SET(VXL_CONVERSIONS_FOUND "ON")
SET(VXL_CONVERSIONS_INCLUDE_DIR "/usr/local/include/vxl/contrib/conversions")
...
SET(VXL_NETLIB_INCLUDE_DIR "/usr/local/include/vxl/v3p/netlib")
SET(VXL_NETLIB_LIBRARIES "netlib;v3p_netlib")

SET(VXL_QV_FOUND "YES")
SET(VXL_QV_INCLUDE_DIR "/usr/local/include/vxl/v3p")
...
SET(VXL_MPEG2_INCLUDE_DIR "/usr/local/include/vxl/v3p/mpeg2/include;/usr/local/include/vxl/v3p/mpeg2/include/mpeg2dec")
