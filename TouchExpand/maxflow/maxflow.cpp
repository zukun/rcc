...
*/
#define TERMINAL ( (arc *) 100 )		/* to terminal */
#define ORPHAN   ( (arc *) 101 )		/* orphan */
...
Graph::termtype Graph::what_segment(node_id i, termtype defaultTerm) //Modified by Victor Lempitsky to include the second argument
{
	if(!((node*)i)->parent)
		return defaultTerm;
